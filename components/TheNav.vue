...
const openMenu =  () => {
    if(openMenuActive.value===''){
        openMenuActive.value = 'active-menu';
        return
    }
    ...
    <div class="container">
        ...
        <div class="nav-responsive">
            <div id="mySidenav" :class="'sidenav ' + openMenuActive">
                <ul class="list">
                    <NuxtLink  v-for="(value,index) in valueMenu" :class="['size-link',{  active: activeItems[index]  }]" @click="closeMenu();toggleActive(index)" :to="value.link" :key="index">{{ value.propos }}</NuxtLink>
                </ul>
            </div>
        ...
        <nav class="nav">
            <ul class="link">
                <NuxtLink  v-for="(value,index) in valueMenu" :class="['size-link',{  active: activeItems[index]  }]" @click="toggleActive(index)" :to="value.link" :key="index">{{ value.propos }}</NuxtLink>
            </ul>
        </nav>
